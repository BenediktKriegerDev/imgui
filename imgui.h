...
namespace ImGui
{
    ...
    IMGUI_API float         GetFontSize();                                                  // get current font size (= height in pixels) of current font with external scale factors applied. Use ImGui::GetStyle().FontSize to get value before external scale factors.
...
struct ImGuiStyle
{
    float       FontSize;                   // Current base font size.  scaling applied). Use PushFont()/PushFontSize() to modify. Use ImGui::GetFontSize() to obtain scaled value.
    ...
    // [Internal]
    float       Scale;                      // FIXME-WIP: Reference scale, as applied by ScaleAllSizes().
